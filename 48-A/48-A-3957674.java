...
public static void main(String[] args) throws IOException
{
    ...
    if(a.equals(b)  && c.equals(beats(a))) out.println("S");
    else if(a.equals(c)  && b.equals(beats(a))) out.println("M");
    else if(c.equals(b)  && a.equals(beats(b))) out.println("F");
    else out.println("?");
    
    out.close();
}
static String beats(String s)
{
    if(s.equals("rock")) return "paper";
